...
int inicio_estado3_1 = 0;                                          // variable que se activa cuando comienza el estado 3 (Realizando experimento)
int inicio_estado3_2 = 0;                                          // variable que se activa cuando comienza el estado 3 (Moviendo a cero)
...
void Temporizador()
{
  if (inicio_estado3_1 == 1 || inicio_estado3_2 == 1)  {
  segundos++;
   }
 }
